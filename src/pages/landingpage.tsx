    ...
    <>
      ...
      <section id="why-us" className="px-[10%] py-24 bg-white text-center">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-13 max-w-[1000px] mx-auto">
          {[
            {img: Item4, title: "Expert Team", content: "Seasoned professionals with deep expertise in blockchain technology and decentralized systems."},
            {img: Item7, title: "Future-Proof Solutions", content: "Building scalable, secure, and sustainable platforms designed for tomorrow's digital landscape."},
            {img: Item6, title: "Transparent & Secure", content: "Commitment to open development, rigorous security audits, and ethical practices in all our projects."},
